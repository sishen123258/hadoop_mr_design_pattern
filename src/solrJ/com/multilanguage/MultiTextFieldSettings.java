...
public class MultiTextFieldSettings {
    ...
    public MultiTextFieldSettings(AnalyzerModes analyzerMode, char keyFromTextDelimiter,
                                  char multiKeyDelimiter, String defaultFieldTypeName,HashMap<String, String> fieldMappings,
