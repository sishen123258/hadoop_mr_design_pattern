...
public class MultiTextFieldTokenizer extends Tokenizer {
    ...
    public void reset() throws IOException {
        ...
        if (this.multiTextInput == null) {
            ...
            this.multiTextInput.setReader(input);
        }
        //获取需要的分词器
    ...
    public LinkedHashMap<String, Analyzer> getNamedAnalyzers() {
        ...
        for (int i = 0; i < this.multiTextInput.keys.size(); i++) {
            ...
            if (fieldType != null) {
                if (this.settings.analyzerMode == MultiTextFieldSettings.AnalyzerModes.query) {
                    ...
                    namedAnalyzers.put(fieldTypeName, ((MultiTextField) fieldType).getMultiTermAnalyzer());
                }else {
